...
import { TeacherRegistrationPage } from "@/modules/auth/presentation/pages/register/TeacherRegistrationPage";
...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("auth.teacherRegistration");
  return { title: t("meta.title") };
}

export default async function AuthRegisterTeacherRoute() {
  ...
  return (
    <TeacherRegistrationPage countries={countries} defaultCountryId={defaultCountryId} />
  );
}
