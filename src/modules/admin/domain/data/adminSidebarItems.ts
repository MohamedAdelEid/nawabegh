...
export const adminSidebarItems: SidebarItems = {
  main: [
    ...
    {
      id: "bundleManagement",
      labelKey: "sidebar.nav.bundleManagement",
      href: ROUTES.ADMIN.BUNDLES.LIST,
      activePathPrefixes: [ROUTES.ADMIN.BUNDLES.LIST, "/admin/bundles/"],
      icon: Package,
    },
    {
      id: "invoiceManagement",
      labelKey: "sidebar.nav.invoiceManagement",
      href: ROUTES.ADMIN.PAYMENTS.OVERVIEW,
      activePathPrefixes: [ROUTES.ADMIN.PAYMENTS.OVERVIEW, "/admin/payments/"],
      icon: Receipt,
    },
    {
