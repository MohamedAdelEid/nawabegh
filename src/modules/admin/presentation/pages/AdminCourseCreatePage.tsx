          ...
          <CourseSectionCard title={t("create.sections.basic")} icon={PencilIcon}>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <label className="space-y-2 text-right">
                <span className="text-sm font-semibold text-slate-600">{t("create.fields.subject")}</span>
                <select
                  value={draft.subject}
                  onChange={(event) => update("subject", event.target.value)}
                  className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 text-right text-sm outline-none"
                >
                  <option value="">{t("create.placeholders.subject")}</option>
              ...
              <label className="space-y-2 text-right">
                <span className="text-sm font-semibold text-slate-600">{t("create.fields.country")}</span>
                <select
                  value={draft.country}
                  onChange={(event) => handleCountryChange(event.target.value)}
                  className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 text-right text-sm outline-none"
                >
                  <option value="">{t("create.placeholders.country")}</option>
              ...
              <label className="space-y-2 text-right">
                <span className="text-sm font-semibold text-slate-600">{t("create.fields.educationLevel")}</span>
                <select
                  value={draft.educationLevel}
                  onChange={(event) => handleEducationLevelChange(event.target.value)}
                  disabled={!draft.country || educationLevelsLoading}
                  className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 text-right text-sm outline-none disabled:cursor-not-allowed disabled:opacity-60"
                >
                  <option value="">{t("create.placeholders.educationLevel")}</option>
              ...
              <label className="space-y-2 text-right">
                <span className="text-sm font-semibold text-slate-600">{t("create.fields.grade")}</span>
                <select
                  value={draft.grade}
                  ...
                  className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 text-right text-sm outline-none disabled:cursor-not-allowed disabled:opacity-60"
                >
                  <option value="">{t("create.placeholders.grade")}</option>
              ...
              <label className="space-y-2 text-right">
                <span className="text-sm font-semibold text-slate-600">{t("create.fields.term")}</span>
                <select
                  value={draft.term}
                  onChange={(event) => update("term", event.target.value)}
                  className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 text-right text-sm outline-none"
                >
                  <option value="">{t("create.placeholders.term")}</option>
              ...
              <label className="space-y-2 text-right">
                <span className="text-sm font-semibold text-slate-600">{t("create.fields.teacher")}</span>
                <select
                  value={draft.teacher}
                  onChange={(event) => update("teacher", event.target.value)}
                  className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 text-right text-sm outline-none"
                >
                  <option value="">{t("create.placeholders.teacher")}</option>
