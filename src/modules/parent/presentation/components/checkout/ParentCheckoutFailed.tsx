...
type ParentCheckoutFailedProps = {
...
export function ParentCheckoutFailed({
  course,
  session,
  result,
  childName,
  ...
  onChangeMethod,
  isRetrying = false,
}: ParentCheckoutFailedProps) {
  const t = useTranslations("parent.dashboard.checkout.failed");
        ...
        <section className="rounded-[20px] border border-[#e2e8f0] bg-white p-6 shadow-sm">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button
              ...
              className="h-12 rounded-xl border-2 border-[#1e88e5] bg-[#1e88e5]/10 font-bold text-[#2b415e]"
            >
