...
type ParentCheckoutStepperProps = {
  currentStep: 1 | 2 | 3 | 4;
};
...
export function ParentCheckoutStepper({ currentStep }: ParentCheckoutStepperProps) {
  const t = useTranslations("parent.dashboard.checkout.stepper");
            ...
            <div className="flex flex-col items-center gap-1">
              <span
                className={cn(
                  ...
                  isCurrent && "border-[#1e88e5] bg-[#1e88e5] text-white",
            ...
            {index < STEPS.length - 1 ? (
              <span
                className={cn(
                  ...
                  step.id < currentStep ? "bg-[#1e88e5]" : "bg-[#e2e8f0]",
                )}
                aria-hidden
              />
            ) : null}
